        ...
        <table class="table table-dark display responsive nowrap" style="border-radius: 3px 3px 3px 3px !important;" id="titular">
            <thead class="thead bg-light">
                <tr>
                    ...
                    <th class="text-center text-uppercase"><?= h('Paciente') ?></th>
                    
                    
                    
                    <th class="text-center text-uppercase"><?= h('División') ?></th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center font-weight-bold text-uppercase"><?= h($person->nombre) ?> <?= h($person->apellido) ?></td>
                    ...
                    <td class="text-center">
                        <?= $this->Html->link(__('+'), ['controller' => 'quotes', 'action' => 'add', $person->id], ['class' => 'fas fa-ticket-alt btn btn-primary btn-lg']) ?>  
                    </td>
                    ...
                    <td class="text-center">
                       <?= $this->Html->link(__(''), ['action' => 'view', $person->id, '_ext' => 'pdf'], ['class' => 'fas fa-file-pdf btn btn-danger btn-lg']) ?>
                    </td>
