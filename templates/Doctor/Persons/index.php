...
<?= $this->Html->css('CakeLte./AdminLTE/plugins/fontawesome-free/css/all.css') ?>
    ...
    <h3 class="text-uppercase font-weight-bold"> <i class="fas fa-users-cog"></i> <?= __('Titulares') ?></h3>
        ...
        <table class="table table-bordered table-dark display responsive nowrap" style="border-radius: 15px 15px 15px 15px !important;" id="titular">
            <thead class="thead-light">
                <tr>
                    ...
                    <!-- <th>< ?= __('Consulta+') ?></th> -->
                    <th class="text-center"><?= __('Modificar') ?></th>
                    <!-- <th>< ?= __('Eliminar') ?></th> -->
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td class="font-weight-bold text-center"><?= $this->Html->link(__(''), ['action' => 'edit', $person->id], ['class' => 'fas fa-user-edit btn btn-warning']) ?> </td>
