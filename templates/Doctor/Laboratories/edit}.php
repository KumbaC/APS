...
<div class="side-nav">
    ...
    <div class="column-responsive column-80">
        ...
        <div class="column-responsive column-80 card mx-auto" style="width: 700px; margin-top:-60px;">
            ...
            <fieldset>
                <legend class="text-center font-weight-bold text-uppercase"><?= __('solicitud de analisis de laboratorio') ?></legend>

                    <?php  //echo $this->Form->control('clinical_history_id', ['options' => $clinicalHistories, 'empty' => true]); ?>


                    <?php  echo $this->Form->control('descripcion', ['id' => 'descripcion', 'label' => 'Observación']); ?>
