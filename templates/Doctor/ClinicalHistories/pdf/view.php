...
<hr class="bg-dark">
   ...
   <table style="width:900px;">
       ...
       <th class="text-uppercase"><?= __('Cedula: ') ?></th>
           ...
           <?php if (!empty($clinicalHistory->doctor->telefono)) : ?>

               <th class="text-uppercase"><?= __('Telefono: ') ?></th>
               <td>+58 <?= h($clinicalHistory->doctor->telefono) ?></td>

            <?php else: ?>

               <th class="text-uppercase"><?= __('Telefono: ') ?></th>
               <td class="font-weight-bold"> NO POSEE<!-- < ?=  h($clinicalHistory->beneficiary->gender->descripcion) ?> --></td>
...
<table style="width:900px; height:800px; position:fixed;">
    <thead>
           <h4 class="h3 text-uppercase font-weight-bold text-center">INDICADORES</h4> 
    </thead>
    <tr>
...
<!-- FIRMA DEL MEDICO -->
<div class="mx-auto" style="margin-top:800px; position:fixed;">


<table class="table-responsive" style="margin-left:220px; height:250px; width:700px;">
    <thead>
    <tr>
        <th class="text-center"> Firma del medico:  </th>
        <th class="text-center"> Requiere el sello instituciónal:  </th>
    </tr>
    </thead>
    <tbody>
...
<!-- PIE DE PAGINA DEL INFORME -->
<div class="text-center" style="margin-top:1020px; position:fixed;">
...
<hr class="bg-dark"> 
      ...
      <br>
       ...
       <div class="table-responsive" style="border:none; width:940px; position: fixed;">
           <table>
             <thead><h5 class="text-uppercase font-weight-bold"><?= __('Enfermedad Actual') ?></h5></thead>
              ...
              <tbody>
               ...
               <tr>
                   <td style="width:1200px;"><?= ($clinicalHistory->disease_current) ?></td>
               </tr>
