        ...
        <div class="prescriptions form content card-body">
            ...
            <fieldset>
                <legend class="text-uppercase font-weight-bold text-center"><?= __('Prescripción Medica') ?> </legend>
                   ...
                   <?php echo $this->Form->control('descripcion', ['type' => 'textarea', 'label' => 'Recipe', 'placeholder' => 'Ejem: Atamel 50MG, Losartan 20MG', 'id' => 'descripcion']); ?>
                   <?php echo $this->Form->control('indicaciones', ['type' => 'textarea', 'label' => 'Indicaciones', 'id' => 'indiciaciones']); ?>
