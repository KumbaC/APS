...
<div class="card">
  <div class="card-body login-card-body">
    ...
    <?= $this->Form->control('username', [
      ...
      'append' => '<i class="fas fa-user-nurse"></i>'
    ]) ?>
    ...
    <div class="row d-flex justify-content-center">
      ...
      <button class="btn btn-secondary btn-sm disabled">
       <a class="fas fa-user-nurse text-white" style="margin-left:8px; font-size:17px;" href="<?= $this->Url->build(['prefix' => 'Admin', 'controller'=>'Users', 'action'=>'login']) ?>">
