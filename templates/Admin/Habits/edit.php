    ...
    <div class="card mx-auto">
        <div class="card-body">
            ...
            <fieldset class="card-body">
                <legend class="font-weight-bold mx-auto text-uppercase"> <?= __('Editar Habito') ?></legend>

                <?php echo $this->Form->control('descripcion', ['placeholder' => 'Introduzca un nuevo habito']); ?>
