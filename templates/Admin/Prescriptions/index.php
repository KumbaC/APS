            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center font-weight-bold">
                        <?= $this->Html->link(__(''), ['action' => 'view', $prescription->id, '_ext' => 'pdf'], ['class' => 'fas fa-file-pdf btn btn-warning']) ?>
                    </td>
                    <td class="text-center font-weight-bold"><?= $this->Html->link(__(''), ['action' => 'edit', $prescription->id], ['class' => 'fas fa-edit btn btn-warning']) ?></td>
