        ...
        <div class="persons view content">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><?= $person->has('users_internal') ? $this->Html->link($person->users_internal->id, ['controller' => 'UsersInternals', 'action' => 'view', $person->users_internal->id]) : '' ?></td>
                </tr>
                <tr>
                    <th><?= __('Unit') ?></th>
                    <td><?= $person->has('unit') ? $this->Html->link($person->unit->id, ['controller' => 'Units', 'action' => 'view', $person->unit->id]) : '' ?></td>
                </tr>
                <tr>
                    <th><?= __('Gender') ?></th>
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><?= h($clinicalHistories->diagnosis_id) ?></td>
