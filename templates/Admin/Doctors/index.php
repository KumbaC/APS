    ...
    <div class="table-responsive">
        <table class="table table-bordered table-dark">
            <thead class="thead thead-light">
                <tr>
                    <th class="text-center text-light"><?= $this->Paginator->sort('id', 'ID') ?></th>
            ...
            <tbody>
                ...
                <tr>
                    <td class="text-light text-center font-weight-bold"><?= $this->Number->format($doctor->id) ?></td>
                    <td class="text-light text-center"><?= h($doctor->nombre) ?></td>
                    <td class="text-light text-center font-weight-bold"><?= h($doctor->apellido) ?></td>
                    <td class="text-light text-center">V- <?= h($doctor->cedula) ?></td>
                    <td class="text-light text-center font-weight-bold"><?= h($doctor->telefono) ?></td>
                    <td class="text-light text-center"><?= h($doctor->email) ?></td>
                    <td class="text-light text-center font-weight-bold"><?= h($doctor->specialty->descripcion) ?></td>
                    <td class="text-light text-center"><?= h($doctor->created) ?></td>
