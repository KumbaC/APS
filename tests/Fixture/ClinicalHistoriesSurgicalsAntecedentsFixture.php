...
/**
 * ClinicalHistoriesSurgicalsAntecedentsFixture
 */
class ClinicalHistoriesSurgicalsAntecedentsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'clinical_histories-surgicals_antecedents_fk' => ['type' => 'foreign', 'columns' => ['surgical_antecedent_id'], 'references' => ['surgicals_antecedents', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
